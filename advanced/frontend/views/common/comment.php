                        ...
                        <div class="itm" data-id="<?=$item['id']?>">
                            ...
                            <div class="cntwrap">
                                ...
                                <div class="rp">
                                    ...
                                    ?>
                                            <span class="dlt">
                                                <a href="javascript:void(0)" class="s-fc3" data-id="<?=$item['id']?>" data-type="delete">删除</a>
                                                 <span class="sep">|</span>
                                            </span>
                                    <?php
                                        }
                                    ?>
                                    <a href="javascript:void(0)" class="s-fc3 a_report" data-id="<?=$item['id']?>" data-type="report">举报</a>
                                    <span class="sep">|</span>
